  ...
  },
{
  ...
  "choices": [
    {
      "text": "アルファルファ、パパイヤ、からしな",
      "correct": false,
      "explanation": "アルファルファ、パパイヤ、からしなは、遺伝子組換え食品として安全性審査を経た品目に含まれます。"
    },
    {
      "text": "とうもろこし、小麦、大豆",
      "correct": true,
    ...
    },
    {
      "text": "なたね、綿実、てん菜",
      "correct": false,
      "explanation": "なたね、綿実、てん菜は遺伝子組換え食品の対象となる品目です。"
    },
    {
      "text": "大豆、ばれいしょ、とうもろこし",
      "correct": false,
      "explanation": "大豆、ばれいしょ、とうもろこしは遺伝子組換え食品の対象となる品目です。"
    }
  ]
},
{
  ...
  "choices": [
    {
      "text": "使用している時と分別していない時",
      "correct": true,
      "explanation": "遺伝子組換え農産物を使用している場合や、分別生産流通管理が行われていない場合には、所定の表示が必要です。"
    },
    {
      "text": "使用している時と完全に分別できている時",
      "correct": false,
      "explanation": "完全に分別管理され、遺伝子組換えでないことが確認された場合は、この組み合わせの説明は適切ではありません。"
    },
    {
      "text": "分別していない時と完全に分別できている時",
      "correct": false,
      "explanation": "完全に分別できている場合まで一律に義務表示となるわけではありません。"
    },
    {
      "text": "使用している時のみ",
      "correct": false,
      "explanation": "使用している場合だけでなく、分別生産流通管理が行われていない場合も表示の対象となります。"
    }
  ]
},
{
  ...
  "choices": [
    {
      "text": "どちらも遺伝子を変えているので、全く自然界にない性質を持つ。",
      "correct": false,
      "explanation": "ゲノム編集では、外来遺伝子を導入せず自然界でも起こり得る変化を利用する場合があります。"
    },
    {
      "text": "遺伝子組換え食品では、他の種類の生物から遺伝子を組み換えているので、自然界にない性質を持つものがある。",
      "correct": true,
      "explanation": "遺伝子組換えでは他の生物由来の遺伝子を導入することがあり、ゲノム編集との代表的な違いです。"
    },
    {
      "text": "ゲノム編集のみ、アレルギーの原因となることがある。",
      "correct": false,
      "explanation": "アレルギーなどの安全性は、ゲノム編集だけに限定される問題ではありません。"
    },
    {
      "text": "ゲノム編集にのみ、生態系に与える影響を検討する必要がある。",
      "correct": false,
      "explanation": "生態系への影響の検討はゲノム編集だけに限られるものではありません。"
    }
  ]
},
{
  ...
  "choices": [
    {
      "text": "カシューナッツ、ピーナッツ、アーモンド",
      "correct": false,
      "explanation": "この組み合わせには、表示義務の対象ではなく推奨表示の品目が含まれます。"
    },
    {
      "text": "えび、かに、卵",
      "correct": true,
    ...
    },
    {
      "text": "小麦、大豆、乳",
      "correct": false,
      "explanation": "小麦と乳は表示義務の対象ですが、大豆は推奨表示の対象です。"
    },
    {
      "text": "ピーナッツ、ごま、くるみ",
      "correct": false,
      "explanation": "落花生とくるみは表示義務の対象ですが、ごまは推奨表示の対象です。"
    }
  ]
},
{
  ...
  "choices": [
    {
      "text": "特定原材料には9品目が指定されている。",
      "correct": false,
      "explanation": "現在、特定原材料として9品目が指定されています。"
    },
    {
      "text": "特定原材料に準ずるものとされている食品は、20品目ある。",
      "correct": false,
      "explanation": "特定原材料に準ずるものとして20品目が位置付けられています。"
    },
    {
      "text": "個別表示は見にくいので、一括表示で表示しなければならない。",
      "correct": true,
    ...
    },
    {
      "text": "魚卵は、表示が義務ではない。",
      "correct": false,
      "explanation": "魚卵一般が特定原材料として一律に表示義務の対象になっているわけではありません。"
    }
  ]
},
{
  ...
  "choices": [
    {
      "text": "軸",
      "correct": false,
      "explanation": "軸は子実体を構成する一部分です。"
    },
    {
      "text": "菌糸",
      "correct": false,
      "explanation": "菌糸はきのこの栄養体を構成しますが、一般に食用として目にする部分全体の名称ではありません。"
    },
    {
      "text": "子実体",
      "correct": true,
    ...
    },
    {
      "text": "胞子",
      "correct": false,
      "explanation": "胞子は繁殖に関わる細胞で、食べているきのこの本体部分を指しません。"
    }
  ]
},
{
  ...
  "choices": [
    {
      "text": "エルゴカルシフェロール",
      "correct": false,
      "explanation": "エルゴカルシフェロールはビタミンD2そのものです。"
    },
    {
      "text": "エルゴステロール",
      "correct": true,
    ...
    },
    {
      "text": "コレステロール",
      "correct": false,
      "explanation": "コレステロールは動物体内で重要な脂質ですが、きのこのビタミンD2の前駆体ではありません。"
    },
    {
      "text": "コレカルシフェロール",
      "correct": false,
      "explanation": "コレカルシフェロールはビタミンD3です。"
    }
  ]
},
{
  ...
  "choices": [
    {
      "text": "イノシン酸",
      "correct": false,
      "explanation": "イノシン酸は、かつお節や肉類などに多いうま味成分です。"
    },
    {
      "text": "グルタミン酸",
      "correct": false,
      "explanation": "グルタミン酸は昆布などに多いうま味成分です。"
    },
    {
      "text": "グアニル酸",
      "correct": true,
    ...
    },
    {
      "text": "クエン酸",
      "correct": false,
      "explanation": "クエン酸は酸味成分で、干ししいたけの代表的なうま味成分ではありません。"
    }
  ]
},
{
  ...
  "choices": [
    {
      "text": "こうしん",
      "correct": false,
      "explanation": "香信（こうしん）は、かさが薄く、比較的よく開いたしいたけです。"
    },
    {
      "text": "こうこ",
      "correct": false,
      "explanation": "香菇（こうこ）は冬菇と香信の中間的な形状のものを指します。"
    },
    {
      "text": "とうこ",
      "correct": false,
      "explanation": "読み方としては『どんこ』です。"
    },
    {
      "text": "どんこ",
      "correct": true,
  ...
  "choices": [
    {
      "text": "A.まつ B.アメリカ",
      "correct": false,
      "explanation": "エリンギはまつたけの仲間ではありません。"
    },
    {
      "text": "A.まつ B.ヨーロッパ",
      "correct": false,
      "explanation": "自生地はヨーロッパなどですが、まつたけの仲間ではありません。"
    },
    {
      "text": "A.ひら B.アメリカ",
      "correct": false,
      "explanation": "ひらたけの仲間ですが、もともとの自生地をアメリカとする組み合わせは適切ではありません。"
    },
    {
      "text": "A.ひら B.ヨーロッパ",
      "correct": true,
  ...
  "choices": [
    {
      "text": "原木栽培",
      "correct": false,
      "explanation": "原木栽培は、しいたけなどの種菌を原木に植え付けて育てる方法です。"
    },
    {
      "text": "おがくず栽培",
      "correct": false,
      "explanation": "おがくずを使いますが、一般的な栽培法の名称は菌床栽培です。"
    },
    {
      "text": "バッグ栽培",
      "correct": false,
      "explanation": "袋を利用する場合もありますが、栽培法の名称としては菌床栽培が適切です。"
    },
    {
      "text": "菌床栽培",
      "correct": true,
  ...
  "choices": [
    {
      "text": "ぶなしめじ",
      "correct": false,
      "explanation": "ぶなしめじではありません。"
    },
    {
      "text": "はたけしめじ",
      "correct": false,
      "explanation": "はたけしめじも食味のよいきのこですが、このことわざの『しめじ』ではありません。"
    },
    {
      "text": "本しめじ",
      "correct": true,
    ...
    },
    {
      "text": "一本しめじ",
      "correct": false,
      "explanation": "一本しめじを指すことわざではありません。"
    }
  ]
},
{
  ...
  "choices": [
    {
      "text": "炭水化物のほとんどは、食物繊維である。",
      "correct": false,
      "explanation": "きのこ類の炭水化物には食物繊維が多く含まれます。"
    },
    {
      "text": "えのきたけ、しいたけは、ビタミンB1、B2が多く含まれる。",
      "correct": false,
      "explanation": "えのきたけやしいたけにはビタミンB群が含まれています。"
    },
    {
      "text": "天日乾燥させたきくらげは、生の時よりビタミンDが多くなる。",
      "correct": false,
      "explanation": "紫外線によってエルゴステロールからビタミンD2が生成されるため、天日乾燥でビタミンDが増えます。"
    },
    {
      "text": "干ししいたけに多いグアニル酸は、熱湯で戻すことでさらに多くできる。",
      "correct": true,
  ...
  "choices": [
    {
      "text": "A：技術的助言 B：企業",
      "correct": false,
      "explanation": "この選択肢は該当しません。労働衛生・労働法規の基本事項を確認しましょう。"
    },
    {
      "text": "A：健康 B：個人",
      "correct": true,
